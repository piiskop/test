...
lang: en
title: |
    Manual for creating content using  
    RStudio Server
...
```{r label = "workflow", fig.cap = paste("The workflow from the written markdown to the ready output using *bookdown*", render_with_emojis(text = "((ref:riederer-122))"), ".", sep = "")}
